...
public class FPegawaiNIMMhs0057 extends JFrame implements ActionListener
{
	...
	public static void main(String[] args) {
		new FPegawaiNIMMhs0057().setVisible(true);
	}
	...
	void Add()
	{
		try	
		{
	   		...
	   		String strsqlcr = "SELECT * FROM pegawai05068 WHERE nip ='" + fNip.getText () + "'";
			...
			if(rs.next())	
			{
	   		...
	   		String strsql = "insert into pegawai05068(nip, nama) values " +
	...
	int Cari(){
		...
		try	{
			...
			KoneksiDBMS CnPenjualan = new KoneksiDBMS();
	   		...
	   		String strsql = "SELECT * FROM pegawai05068 WHERE nip ='" + fNip.getText () + "'";
	...
	void Koreksi()
	{
		try	
		{
	   		...
	   		String strsql = "update pegawai05068 set nama='"+fNama.getText()+
	...
	void Hapus()
	{
		try	
		{
	   		...
	   		String strsql = "delete from pegawai05068 where nip='"+fNip.getText()+"' ";
	   		int stsproses = stat.executeUpdate(strsql);
	...
	void tampiltabel()
	{
        try {
            bersihtabel();
	   		...
	   		Connection con = CnPenjualan.BukaCn();
	   		Statement stat = con.createStatement(); 
	   		String strsql = "select * from pegawai05068";
